...
describe('ninemsn code test', function() {

    it('returns 7 items for drm true and episodeCount > 0', function (done) {
        superagent.post('http://localhost:5000/')
            ...
            .end(function (e, res) {
                ...
                var filteredResponse  = res.body["response"];
                expect(filteredResponse.length).to.eql(7);
                done();
            });
    });
});